        ...
        >
          ...
          <div className="highlightedProject" style={{ marginBottom: "2rem" }}>
            <div className="item">
              ...
              <HighlightedApp
                mainLink="https://ems-x.herokuapp.com"
          ...
          <div className="projects">
            ...
            <div className="item">
              ...
              <WrokTemplate
                mainLink="https://the-tech-shop.herokuapp.com"
            ...
            <div className="item">
              ...
              <WrokTemplate
                mainLink="https://mongo-upload.herokuapp.com"
            ...
            <div className="item">
              ...
              <WrokTemplate
                mainLink="https://spacex-2022.herokuapp.com"
            ...
            <div className="item">
              ...
              <WrokTemplate
                mainLink="https://node-books-shop.herokuapp.com"
            ...
            <div className="item">
              <Suspense fallback={<div className="loader"></div>}>
                <ImageComponent
                  ...
                  jpg={ReactiveBurger}
                  title="Reaxtive Burger"
                />
              </Suspense>
              <WrokTemplate
                mainLink="https://github.com/dzenis-h/Reactive-Burger"
                github="https://reactive-hamburger.web.app/"
            ...
            <div className="item">
              <Suspense fallback={<div className="loader"></div>}>
                <ImageComponent
                  ...
                  jpg={LoanCalculator2}
                  title="Loan Calculator that will determine your estimated paymentsfor loan amounts, interest rates and terms."
                />
              </Suspense>
          ...
          <div className="projects">
            ...
            <div className="item">
              ...
              <WrokTemplate
                mainLink="https://evolwe-example-site.web.PP"
            ...
            <div className="item">
              <Suspense fallback={<div className="loader"></div>}>
                <ImageComponent
                  webp={Portfolio_34}
                  jpg={Portfolio}
                  title="This is a precursor of my current personal portfolio site, but regardless, this one is fully functional as it is."
                />
              </Suspense>

              <WrokTemplate
                mainLink="https://static-portfolio-2.web.app/“  "
                github="https://github.com/dzenis-h/digitalCV"
                name="Porfolio Demo"
                description="This site was build for testing purposes only. 🖥️ 📶"
              />
            </div>
