      ...
      <div className="item-description">
        ...
        >
          <h4
            className={
              darkMode === "true"
                ? "work-heading-segments costom-text"
                : "work-heading-segments app-names__reverse"
            }
          >
            {" "}
            Highlighted App
          ...
          <span className="text-secondary" aria-label="dash">
            <b>
              <i className="dark-text">Mars EMS</i> ➖
            </b>
          </span>{" "}
          <i>
            Full stack web app build using the <span className="diff-text">MERN</span> stack{" "}
          </i>
